        ...
        <div class="py-4">
            ...
            <div class="space-y-2">
                ...
                <div>
                    ...
                    <form action="/keranjang/update/{{ $index }}" method="POST" id="checkboxForm">
                        @csrf
                        <div class="px-4 space-y-2" id="checkboxContainer">
                            @foreach (json_decode($menu->add_on) as $index => $addOnValue)
                                @php
                            ...
                            <div class="px-4">
                                <div class="w-full bg-white px-4 py-2 space-x-3 rounded-lg outline outline-1 shadow-md">
                                    <textarea class="w-full bg-transparent text-sm focus:outline-none" name="catatan" id="catatan"
                                        placeholder="Catatan Makanan (Opsional)" autocomplete="off" rows="5">{{ old('catatan', $data['catatan']) }}</textarea>
                                </div>
                            </div>
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <div class="w-10">
                                        <input class="w-full text-lg leading-none text-center" type="number"
                                            name="jumlah_menu" id="jumlah_menu" value="{{ $data['jumlah_menu'] }}"
                                            min="1" max="999">
                                    </div>
