    ...
    <div class="h-screen hidden md:block lg:max-w-[1000px] bg-white shadow-md mx-auto">
        ...
        <div class="flex w-full h-full">
            <div class="flex flex-col justify-between w-[35%] shadow-xl pt-4 pb-24">
                <div class="space-y-5">
                    <div class="w-[75%] h-fit mx-auto {{ request()->is('dashboard') || request()->is('dashboard/filter*') || request()->is('dashboard/pesanan-baru*') || request()->is('dashboard/pesanan-belumbayar*') || request()->is('dashboard/pesanan-selesai*') ? 'bg-blue-500 text-white' : 'border-2 border-blue-500 text-blue-500' }} rounded-lg"
                        href="/dashboard">
                        <a class="flex justify-center text-sm text-center py-3 px-2" href="/dashboard">Dashboard</a>
                    </div>
                    <div class="w-[75%] h-fit mx-auto {{ request()->is('dashboard/pesanan*') && !request()->is('dashboard/pesanan-lainnya*') && !request()->is('dashboard/pesanan-baru*') && !request()->is('dashboard/pesanan-belumbayar*') && !request()->is('dashboard/pesanan-selesai*') ? 'bg-blue-500 text-white' : 'border-2 border-blue-500 text-blue-500' }} rounded-lg"
                        href="/dashboard">
                        <a class="flex justify-center text-sm text-center py-3 px-2" href="/dashboard/pesanan">Data
                            Pesanan</a>
                    </div>
                    <div class="w-[75%] h-fit mx-auto {{ request()->is('dashboard/menu*') ? 'bg-blue-500 text-white' : 'border-2 border-blue-500 text-blue-500' }} rounded-lg"
                        href="/dashboard">
                        <a class="flex justify-center text-sm text-center py-3 px-2" href="/dashboard/menu">Data
                            Menu</a>
                    </div>
                    <div class="w-[75%] h-fit mx-auto {{ request()->is('dashboard/pesanan-lainnya*') ? 'bg-blue-500 text-white' : 'border-2 border-blue-500 text-blue-500' }} rounded-lg"
                        href="/dashboard">
                        <a class="flex justify-center text-sm text-center py-3 px-2"
                            href="/dashboard/pesanan-lainnya">Pesanan Lainnya</a>
                    </div>
                    <div class="w-[75%] h-fit mx-auto {{ request()->is('dashboard/pengeluaran*') ? 'bg-blue-500 text-white' : 'border-2 border-blue-500 text-blue-500' }} rounded-lg"
                        href="/dashboard">
                        <a class="flex justify-center text-sm text-center py-3 px-2"
                            href="/dashboard/pengeluaran">Pengeluaran</a>
                    </div>
                    <div class="w-[75%] h-fit mx-auto {{ request()->is('dashboard/laporan-keuangan*') ? 'bg-blue-500 text-white' : 'border-2 border-blue-500 text-blue-500' }} rounded-lg"
                        href="/dashboard">
                        <a class="flex justify-center text-sm text-center py-3 px-2"
                            href="/dashboard/laporan-keuangan">Laporan Keuangan</a>
                    </div>
                    <div class="w-[75%] h-fit mx-auto {{ request()->is('dashboard/rating') ? 'bg-blue-500 text-white' : 'border-2 border-blue-500 text-blue-500' }} rounded-lg"
                        href="/dashboard">
