...
<body>
    <div class="w-full min-h-dvh md:max-w-[480px] bg-white shadow-md mx-auto">
                    ...
                    @foreach ($data as $item)
                        <div class="w-full rounded-xl overflow-hidden shadow-md">
                            <div class="relative aspect-[6/4] overflow-hidden">
                                <img class="w-full h-full object-cover {{ $item->stok_menu == 0 ? 'grayscale' : 'grayscale-0' }}"
                                    src="{{ asset('storage/' . $item->gambar_menu) }}" alt="menu image">
                            </div>
                            <div class="">
                                <div class="py-2 px-4">
                                    <div class="font-bold text-xl">{{ $item->nama_menu }}</div>
                                    <div class="text-sm text-justify text-gray-500">{{ $item->deskripsi_menu }}
                                    </div>
        ...
        @if (count($keranjang) !== 0 && !empty($pesanan))
