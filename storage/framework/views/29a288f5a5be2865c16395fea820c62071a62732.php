    ...
    <div class="p-4">
        ...
        <div>
            ...
            <div class="font-bold text-lg pt-4">Total Pesanan Lainnya:
                Rp.<?php echo e(isset($data) && count($data) !== 0 ? number_format($totalPesananLainnya, 0, ',', '.') : 0); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Project\sarah\e-menu\resources\views/dashboard/pesananLainnya/index.blade.php ENDPATH**/ ?>