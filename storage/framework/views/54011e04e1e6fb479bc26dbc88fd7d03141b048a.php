...
<body>
    <div class="min-h-dvh w-full md:max-w-[480px] bg-white shadow-md mx-auto">
        ...
        <div class="py-4 pb-20">
            ...
            <?php if(empty($pesanan['keranjang']) || count($pesanan['keranjang']) == 0): ?>
            ...
            <?php else: ?>
                <div class="grid grid-cols-1 w-full gap-x-4 px-6 gap-y-6">
                    <?php $__currentLoopData = $pesanan['keranjang']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="w-full p-3 rounded-md overflow-hidden border-2 border-black shadow-md">
                            <div class="flex justify-between">
                                ...
                                <div class="flex space-x-2">
                                    <a href="<?php echo e(url('/keranjang/edit/' . $index)); ?>" class="text-blue-500">Edit</a>
                                    <div>Jumlah</div>
                                    <div><?php echo e($item['jumlah_menu']); ?></div>
                                </div>
                            </div>
                            <?php $__currentLoopData = json_decode($item['add_on']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $addOnValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="text-gray-500 text-sm"><?php echo e($addOnValue); ?></div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <div class="font-semibold pt-4">Catatan:</div>
                            <div class="text-gray-500 text-sm">
                                <?php echo e(isset($item['catatan']) ? $item['catatan'] : 'Tidak ada catatan'); ?></div>
                            <div class="flex justify-between items-center">
                                <div class="font-semibold text-xl pt-2">
                                    Rp.<?php echo e(number_format($item['harga_menu'], 0, ',', '.')); ?>

                                </div>
                                <a href="<?php echo e(url('/keranjang/hapus/' . $index)); ?>" class="text-red-500">Hapus</a>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                ...
                <div class="bottom-0 fixed w-full md:max-w-[480px] py-4 space-y-3 bg-white shadow-md border-t-4">
                    <div class="w-full px-6">
                        <div id="pilihPembayaranBtn"
                            ...
                            <div>
                                <?php echo e(isset($pesanan['opsi_pembayaran']) ? 'Pembayaran: ' . $pesanan['opsi_pembayaran'] : 'Pilih Pembayaran'); ?>
                    ...
                    <div class="flex w-full h-full justify-between items-center px-6">
                        ...
                        <div>
                            <?php if($pesanan['opsi_pembayaran'] == null): ?>
                            ...
                            <?php elseif($pesanan['opsi_pembayaran'] == 'Bayar Ditempat'): ?>
                                <a href="<?php echo e(url('/pesanan')); ?>" id="pay-button"
...
<?php /**PATH E:\Project\sarah\e-menu\resources\views/keranjang/index.blade.php ENDPATH**/ ?>