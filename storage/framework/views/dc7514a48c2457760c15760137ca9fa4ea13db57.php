    ...
    <div class="p-4">
        <div class="w-[60%]">
            <div class="grid grid-cols-2 gap-4">
                <?php $__currentLoopData = $pesananBaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="w-fit border-2 border-black">
                        ...
                        <div class="px-4 pb-4 uppercase font-semibold text-center"><?php echo e($item->status_pesanan); ?></div>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Project\sarah\e-menu\resources\views/dashboard/pesananbaru/index.blade.php ENDPATH**/ ?>