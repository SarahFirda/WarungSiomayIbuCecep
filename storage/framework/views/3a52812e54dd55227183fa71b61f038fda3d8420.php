        ...
        <div class="py-4 pb-24">
            ...
            <div class="space-y-2">
                ...
                <div>
                    ...
                    <form action="/keranjang/<?php echo e($data->id_menu); ?>" method="POST" id="checkboxForm">
                        <?php echo csrf_field(); ?>
                        <div class="px-4 space-y-2" id="checkboxContainer">
                            <?php $__currentLoopData = json_decode($data->add_on); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $addOnValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="px-4">
                                <div class="w-full bg-white px-4 py-2 space-x-3 rounded-lg outline outline-1 shadow-md">
                                    <textarea class="w-full bg-transparent text-sm focus:outline-none" name="catatan" id="catatan"
                                        placeholder="Catatan Makanan (Opsional)" autocomplete="off" rows="5"><?php echo e(old('catatan')); ?></textarea>
                                </div>
                            </div>
...
<?php /**PATH E:\Project\sarah\e-menu\resources\views/menu/detail.blade.php ENDPATH**/ ?>