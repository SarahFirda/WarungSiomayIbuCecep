...
} elseif ($_instance->childHasBeenRendered('fCsVP55')) {
    $componentId = $_instance->getRenderedChildComponentId('fCsVP55');
    $componentTag = $_instance->getRenderedChildComponentTagName('fCsVP55');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('fCsVP55');
} else {
    $response = \Livewire\Livewire::mount('select-option', ['pesananData' => $model]);
    $html = $response->html();
    $_instance->logRenderedChild('fCsVP55', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-menu\resources\views/dashboard/pesanan/formMenu.blade.php ENDPATH**/ ?>