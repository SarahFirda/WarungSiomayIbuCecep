...
<?php $__env->startSection('title'); ?>
    <title>Dashboard - Pendapatan Luar</title>
...
<?php $__env->startSection('content'); ?>
    <div class="p-4">
        <div class="relative flex justify-center items-center pb-4">
            <div class="font-bold text-2xl">Pendapatan</div>
        ...
        <div>
                                ...
                                <td class="w-[30%] border-2 border-black py-2">
                                    <div class="flex justify-center space-x-2">
                                        <a class="bg-yellow-500 px-4 py-1 rounded-md text-white"
                                            href="/dashboard/pendapatan/<?php echo e($item->id_pendapatan); ?>/edit">Edit</a>
                                        <form action="/dashboard/pendapatan/<?php echo e($item->id_pendapatan); ?>" method="post"
            ...
            <div class="font-bold text-lg pt-4">Total Pendapatan Luar:
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Project\sarah\e-menu\resources\views/dashboard/pendapatan/index.blade.php ENDPATH**/ ?>