...
<?php $__env->startSection('title'); ?>
    <title>Dashboard - Pembelanjaan</title>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('header'); ?>
    <div class="flex items-center shadow-lg pl-4 py-4 font-bold text-xl capitalize">Data Pembelanjaan</div>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
    <div class="p-4">
        <div class="relative flex justify-center items-center pb-4">
            <div class="font-bold text-2xl">Pembelanjaan</div>
            <div class="absolute right-0">
                <a class="font-medium text-white bg-green-500 px-6 py-2 rounded-lg"
                    href="/dashboard/pembelanjaan/create">Tambah</a>
            </div>
        </div>
        ...
        <div>
                                ...
                                <td class="w-[30%] border-2 border-black py-2">
                                    <div class="flex justify-center space-x-2">
                                        <a class="bg-yellow-500 px-4 py-1 rounded-md text-white"
                                            href="/dashboard/pembelanjaan/<?php echo e($item->id_pembelanjaan); ?>/edit">Edit</a>
                                        <form action="/dashboard/pembelanjaan/<?php echo e($item->id_pembelanjaan); ?>" method="post"
            ...
            <div class="font-bold text-lg pt-4">Total Pembelanjaan:
                Rp.<?php echo e(isset($data) && count($data) !== 0 ? number_format($totalPembelanjaan, 0, ',', '.') : 0); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Project\sarah\e-menu\resources\views/dashboard/pembelanjaan/index.blade.php ENDPATH**/ ?>