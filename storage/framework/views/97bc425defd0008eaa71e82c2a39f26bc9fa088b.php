    ...
    <div class="min-h-dvh w-full md:max-w-[480px] bg-white shadow-md mx-auto">
        ...
        <div class="py-4">
            <div class="flex items-center space-x-4 px-4 pb-6">
                <a href="/keranjang"> <svg class="w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                        <path
                            d="M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.2 288 416 288c17.7 0 32-14.3 32-32s-14.3-32-32-32l-306.7 0L214.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" />
                    </svg></a>
                <div class="font-bold text-xl leading-none">Edit Pesanan</div>
            </div>
            <div class="space-y-2">
                <div class="px-4 pb-4 space-y-4 border-b-[6px]">
                    <div class="flex justify-between">
                        <div class="font-bold text-lg"><?php echo e($data['nama_menu']); ?></div>
                        <div class="font-bold text-lg">Rp.<?php echo e(number_format($data['harga_menu'], 0, ',', '.')); ?></div>
                    </div>
                </div>
                <div>
                    ...
                    <form action="/keranjang/update/<?php echo e($index); ?>" method="POST" id="checkboxForm">
                        <?php echo csrf_field(); ?>
                        <div class="px-4 space-y-2" id="checkboxContainer">
                            <?php $__currentLoopData = json_decode($menu->add_on); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $addOnValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $isChecked = in_array($addOnValue, json_decode($data['add_on']));
                                ?>
                                <label for="checkbox<?php echo e($index + 1); ?>"
                                    class="flex items-center space-x-4 pb-2 <?php echo e($loop->last ? '' : 'border-b-2'); ?> ">
                            ...
                            <div class="px-4">
                                <div class="w-full bg-white px-4 py-2 space-x-3 rounded-lg outline outline-1 shadow-md">
                                    <textarea class="w-full bg-transparent text-sm focus:outline-none" name="catatan" id="catatan"
                                        placeholder="Catatan Makanan (Opsional)" autocomplete="off" rows="5"><?php echo e(old('catatan', $data['catatan'])); ?></textarea>
                                </div>
                            </div>

                        </div>

                        <div class="bottom-0 fixed w-full md:max-w-[480px] py-3 space-y-3 border-t-4 shadow-md px-6">
                            <div class="flex justify-between">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <div class="w-10">
                                        <input class="w-full text-lg leading-none text-center" type="number"
                                            name="jumlah_menu" id="jumlah_menu" value="<?php echo e($data['jumlah_menu']); ?>"
                                            min="1" max="999">
                                    </div>
    ...
    <script>
        ...
        checkboxes.forEach(checkbox => {
            checkbox.addEventListener('click', function() {
                ...
                // Toggle font-semibold class when checkbox is checked or unchecked
                if (this.checked) {
                ...
                // Toggle SVG when checkbox is checked or unchecked
                if (this.checked) {
                    svg.innerHTML =
...
<?php /**PATH E:\Project\sarah\e-menu\resources\views/keranjang/edit.blade.php ENDPATH**/ ?>